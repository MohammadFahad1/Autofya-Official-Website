      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-4 flex flex-col justify-between h-full space-y-6">
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-md group cursor-pointer aspect-[16/10] border-2 border-slate-100">
              ...
              <div className="absolute inset-0 bg-black/20 flex items-center justify-center">
                <div className="w-12 h-12 rounded-full bg-[#00A3AD] text-white flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
          ...
          <div className="lg:col-span-3 flex flex-col justify-between h-full pt-4 lg:pt-0">
            <div>
              {/* Accreditations Icon */}
              <div className="w-10 h-10 rounded-xl bg-[#00A3AD]/10 flex items-center justify-center text-[#00A3AD] mb-4">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
              </div>

              <h3 className="text-lg sm:text-xl font-bold text-[#00A3AD] mb-4 pb-2 border-b border-slate-100">

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-16">
          ...
          <div>
            <a
              href="#services"
              className="inline-flex items-center gap-2 text-sm sm:text-base font-bold text-[#00A3AD] hover:text-[#0B1340] transition-colors group"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          ...
          <div className="flex flex-col justify-center p-4 sm:p-6 bg-transparent group">
            <div className="w-12 h-12 rounded-2xl bg-[#00A3AD]/10 text-[#00A3AD] flex items-center justify-center mb-6">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
              </svg>
            </div>
            <h3 className="text-2xl font-bold text-[#0B1340] mb-3 group-hover:text-[#00A3AD] transition-colors">
              Staff Augmentation
            </h3>
